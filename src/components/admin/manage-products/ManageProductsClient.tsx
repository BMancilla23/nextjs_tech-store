...
export const ManageProductsClient:FC<ManageProductsClientProps> = ({products}) => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      field: "inStock", headerName: "inStock", width: 120, renderCell: (params) => {
        return (
          <div>{params.row.inStock === true ? (<Badge text="in stock" icon={MdDone} bg="bg-teal-200" color="text-teal-700"/>) : (<Badge text="Out of stock" icon={MdClose} bg="bg-rose-200" color="text-rose-700"/>)}</div>
        )
      }
    },
    {
  ...
  return (
    <>
      <div className="mb-4 mt-8"><Heading title="Manage Products" center/></div>
